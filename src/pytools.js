define(["require", "exports", './pytools/parser', './pytools/builder', './py-to-sk/sk-compiler', './py-to-es/ts-compiler', './mstools/mathscript', './mstools/mathscript', './mstools/mathscript'], function (require, exports, parser_1, builder_1, sk_compiler_1, ts_compiler_1, mathscript_1, mathscript_2, mathscript_3) {
    "use strict";
    var pytools = {
