define(["require", "exports", './tables', './asserts', './base', './Tokenizer', './Tokens', './tokenNames'], function (require, exports, tables_1, asserts_1, base_1, Tokenizer_1, Tokens_1, tokenNames_1) {
    "use strict";
