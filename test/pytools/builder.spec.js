...
describe('AST', function () {
    ...
    it('a', function () {
        var cst = parser_1.parse(fileName, 'a');
        var ast = builder_1.astFromParse(cst, fileName);
        var dump = builder_1.astDump(ast);
    ...
    it('def foo(x):\n pass', function () {
        var cst = parser_1.parse(fileName, 'def foo(x):\n pass');
        var ast = builder_1.astFromParse(cst, fileName);
        var dump = builder_1.astDump(ast);
    ...
    it('def foo(x, y):\n pass', function () {
        var cst = parser_1.parse(fileName, 'def foo(x, y):\n pass');
        var ast = builder_1.astFromParse(cst, fileName);
        var dump = builder_1.astDump(ast);
    ...
    it('if a:\n pass', function () {
        var cst = parser_1.parse(fileName, 'if a:\n pass');
        var ast = builder_1.astFromParse(cst, fileName);
        var dump = builder_1.astDump(ast);
    ...
    it('while a:\n pass', function () {
        var cst = parser_1.parse(fileName, 'while a:\n pass');
        var ast = builder_1.astFromParse(cst, fileName);
        var dump = builder_1.astDump(ast);
    ...
    it('ParseError', function () {
        try {
            var cst = parser_1.parse(fileName, 'print 1s');
            var ast = builder_1.astFromParse(cst, fileName);
            var dump = builder_1.astDump(ast);
    ...
    it('IndentationError', function () {
        try {
            var cst = parser_1.parse(fileName, 'def f():\n    pass\n print');
            var ast = builder_1.astFromParse(cst, fileName);
            var dump = builder_1.astDump(ast);
    ...
    it('SyntaxError from builder', function () {
        try {
            var cst = parser_1.parse(fileName, '()=1');
            var ast = builder_1.astFromParse(cst, fileName);
            var dump = builder_1.astDump(ast);
    ...
    xit('SyntaxError from symtable', function () {
        try {
            var cst = parser_1.parse(fileName, 'def f(x,x):\n  pass');
            var ast = builder_1.astFromParse(cst, fileName);
            /*var dump =*/ builder_1.astDump(ast);
