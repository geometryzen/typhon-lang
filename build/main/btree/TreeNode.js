...
var TreeNode = (function () {
    ...
    TreeNode.prototype.put = function (key, value, order, compare, overwrite) {
        ...
        node.leaves.splice(index, 0, new Leaf_1.Leaf(node, key, value));
    ...
    TreeNode.prototype.balance = function (minOrder) {
        if (this.parent instanceof btree_1.Tree) {
    ...
    TreeNode.prototype.toString = function (includeNodes) {
        ...
        var s = "[" + val.toString() + "]" + (this.parent instanceof btree_1.Tree ? ":*" : ":" + this.parent);
        if (includeNodes) {
